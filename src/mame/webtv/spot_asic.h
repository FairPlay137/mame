...
constexpr float    AUD_OUTPUT_GAIN = 1;
...
constexpr uint8_t DS2401_STATE_IDLE               = 0x0;
constexpr uint8_t DS2401_STATE_RESET              = 0x1;
constexpr uint8_t DS2401_STATE_PRESENCE           = 0x2;
constexpr uint8_t DS2401_STATE_COMMAND            = 0x3;
constexpr uint8_t DS2401_STATE_READROM            = 0x4;
constexpr uint8_t DS2401_STATE_READROM_PULSESTART = 0x5;
constexpr uint8_t DS2401_STATE_READROM_PULSEEND   = 0x6;
constexpr uint8_t DS2401_STATE_READROM_BIT        = 0x7;
